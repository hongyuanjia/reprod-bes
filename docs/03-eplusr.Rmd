...
if (!knitr::is_latex_output()) {
    rmarkdown::paged_table(head(rdd, 10))
} else {
    knitr::kable(head(rdd, 10), booktabs = TRUE, linesep = "")
}
...
if (!knitr::is_latex_output()) {
    rmarkdown::paged_table(head(mdd, 10))
} else {
    knitr::kable(head(mdd, 10), booktabs = TRUE, linesep = "")
}
```
