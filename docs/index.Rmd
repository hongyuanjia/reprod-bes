...
Welcome to the Reproducing building simulations using R by [Hongyuan Jia](http://hongyuanjia.me).
...
various open-source books, reports, papers and manuals, including:

* rOpenSci Reproducibility Guide [@ropensci2018reproducibility]
* R Packages book [@wickham2015packages]
* Reproducible computation at scale in R with {targets} toturial [@landau2021reproducible]
* {usethis}
...
* R Markdown: The Definitive Guide book [@xie2018markdown]
